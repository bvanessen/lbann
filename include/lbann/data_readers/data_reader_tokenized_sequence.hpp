...
#ifndef LBANN_DATA_READER_TOKENIZED_SEQUENCE_HPP
#define LBANN_DATA_READER_TOKENIZED_SEQUENCE_HPP
...
using special_tokens_iterator = enum_iterator<special_tokens, special_tokens::PAD, special_tokens::EOS>;
   ...
   */
class tokenized_sequence_data_reader : public data_reader_sample_list<sample_list_ifstream<long long>> {
public:
  ...
  tokenized_sequence_data_reader& operator=(const tokenized_sequence_data_reader&);
  ~tokenized_sequence_data_reader() override;

  tokenized_sequence_data_reader* copy() const override { return new tokenized_sequence_data_reader(*this); }

  std::string get_type() const override {
    return "tokenized_sequence_data_reader";
  }
  ...
  /** This method made public for use during testing. */
  // reads and returns the tokenized_sequence string from the input stream
...
private:
   ...
   *  Also, 'file' or 'filename' refers to a file containing TOKENIZED_SEQUENCE strings.
   *
  ...
  void copy_members(const tokenized_sequence_data_reader& rhs);
...
#endif //LBANN_DATA_READER_TOKENIZED_SEQUENCE_HPP
